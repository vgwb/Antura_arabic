...
namespace TMPro
{
    ...
    {
        public TMP_FontAsset_OLD regularTypeface;
        public TMP_FontAsset_OLD italicTypeface;
    }



    [Serializable]
    public class TMP_FontAsset_OLD : TMP_Asset
    {
        /// <summary>
        ...
        public static TMP_FontAsset_OLD defaultFontAsset
        {
            get
            {
                ...
                {
                    s_defaultFontAsset = Resources.Load<TMP_FontAsset_OLD>("Fonts & Materials/LiberationSans SDF");
                }

                return s_defaultFontAsset;
            }
        }
        private static TMP_FontAsset_OLD s_defaultFontAsset;
        ...
        /// </summary>
        [SerializeField]
        public List<TMP_FontAsset_OLD> fallbackFontAssets;
        ...
        /// <returns></returns>
        public static string GetCharacters(TMP_FontAsset_OLD fontAsset)
        {
        ...
        /// <param name="fontAsset"></param>
        /// <returns></returns>
        public static int[] GetCharactersArray(TMP_FontAsset_OLD fontAsset)
        {
