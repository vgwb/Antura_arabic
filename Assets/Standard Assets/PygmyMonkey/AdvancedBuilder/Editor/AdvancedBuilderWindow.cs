...
namespace PygmyMonkey.AdvancedBuilder
{
	public class AdvancedBuilderWindow : PMEditorWindow
	{
		...
		*/
		...
		{
			m_advancedBuilder = PMUtils.CreateScriptableObject<AdvancedBuilder>("Assets/Standard Assets/PygmyMonkey/AdvancedBuilder/Editor/AdvancedBuilder.asset");
			m_appParameters = PMUtils.CreateScriptableObject<AppParameters>("Assets/Standard Assets/PygmyMonkey/AdvancedBuilder/Resources/AppParameters.asset");
		}
	}
}