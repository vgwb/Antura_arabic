...
namespace Antura.Test
{
    ...
    public class Tester_GameResultUI : MonoBehaviour
    {
        ...
        public void EndsessionResult_Show(int _totMinigamesStars)
        {
            ...
            MiniGameData d0 = new MiniGameData() { Main = MiniGameCode.Maze_letter.ToString(), Variation = "letters" };
            MiniGameData d1 = new MiniGameData() { Main = MiniGameCode.DancingDots_letter.ToString(), Variation = "alphabet" };
            MiniGameData d2 = new MiniGameData() { Main = MiniGameCode.MakeFriends_letterform.ToString(), Variation = "counting" };
