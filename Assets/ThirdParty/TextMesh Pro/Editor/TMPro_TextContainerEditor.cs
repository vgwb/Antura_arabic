    ...
    public class TMPro_TextContainerEditor : Editor
    {
        ...
        void OnSceneGUI()
        {
            ...
            */
            ...
            //bool isShiftKey = evt.shift; // Should implement this with margins.
            ...
            */
            ...
            RectTransform rectTransform = m_textContainer.rectTransform;
            rectTransform.GetWorldCorners(m_Margin_handlePoints);

            m_Margin_handlePoints[0] += new Vector3(textMargins.x * lossyScale.x, textMargins.w * lossyScale.y, 0); // BL
            m_Margin_handlePoints[1] += new Vector3(textMargins.x * lossyScale.x, -textMargins.y * lossyScale.y, 0); // TL
            m_Margin_handlePoints[2] += new Vector3(-textMargins.z * lossyScale.x, -textMargins.y * lossyScale.y, 0); // TR
            m_Margin_handlePoints[3] += new Vector3(-textMargins.z * lossyScale.x, textMargins.w * lossyScale.y, 0);   // BR
