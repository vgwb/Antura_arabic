...
namespace Google2u
{
	...
	public sealed class words : IGoogle2uDB
	{
		public enum rowIds {
			...
			, bear, girl, boy, kid, man, woman, grandson, granddaughter, day, month, year, hour, second, hair, face, tongue, chest, back, hot_food, cold_food
		...
		private words()
		{
			...
			Rows.Add( new wordsRow("hot_food", "noun", "food", "2", "Hot (warm, not spicy)", "سخن", "سـ ـخـ ـن", "sekhen", "", "3", ""));
			Rows.Add( new wordsRow("cold_food", "noun", "food", "2", "Cold", "بارد", "بـ ـا ر د", "bared", "", "4", ""));
