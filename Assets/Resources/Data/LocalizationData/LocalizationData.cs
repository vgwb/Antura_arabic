...
namespace Google2u
{
	...
	public sealed class LocalizationData : IGoogle2uDB
	{
		...
		private LocalizationData()
		{
			...
			Rows.Add( new LocalizationDataRow("game_dontwake_intro1", "keeper", "game_dontwake", "Shhh! All are asleep. ", "هشششش! الجميع نائم...", "game_dontwake_intro1", "Shhhh! Everybody is sleeping…"));
