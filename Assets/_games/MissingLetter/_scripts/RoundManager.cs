...
namespace EA4S.Minigames.MissingLetter
{
    ...
    public class RoundManager
    {
        ...
        private List<LL_WordData> GetWordsFromPhrase(LL_PhraseData _phrase)
        {
            ...
            var dbWords = AppManager.Instance.VocabularyHelper.GetWordsInPhrase(_phrase.Id);
        ...
        ArabicAlphabetHelper.ArabicStringPart RemoveLetterFromQuestion(LL_LetterData letter)
        {
            ...
            var parts = ArabicAlphabetHelper.FindLetter(AppManager.Instance.DB, word.Data, letter.Data);
