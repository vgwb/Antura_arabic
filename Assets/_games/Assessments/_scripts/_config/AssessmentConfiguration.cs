...
namespace EA4S.Assessment
{
    public class AssessmentConfiguration : IAssessmentConfiguration
    {
        ...
        {
            return new RandomLettersQuestionBuilder(nPacks: 10, nCorrect:1, firstCorrectIsQuestion:true, nWrong: 5, correctChoicesHistory: Teacher.PackListHistory.ForceAllDifferent, wrongChoicesHistory: Teacher.PackListHistory.ForceAllDifferent);
        }
