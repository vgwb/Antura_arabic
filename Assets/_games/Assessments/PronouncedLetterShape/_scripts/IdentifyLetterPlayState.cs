...
namespace EA4S.IdentifyLetter
{
    public class PlayGameState : IGameState
    {
        ...
        {
            int questionsNumber = IdentifyLetterConfiguration.Instance.SimultaneosQuestions;
            int rounds = IdentifyLetterConfiguration.Instance.Rounds;
            IQuestionProvider provider = IdentifyLetterConfiguration.Instance.Questions;
