...
namespace EA4S.AnturaSpace
{
    ...
    public class AnturaSpaceManager : MonoBehaviour
    {
        ...
        public bool HasPlayerBones {
            get {
                var totalBones = AppManager.Instance.Player.GetTotalNumberOfBones();
        ...
        public void ThrowBone()
        {
            ...
            if (bones.Count < MaxBonesInScene && AppManager.Instance.Player.TotalNumberOfBones > 0) {
                ...
                bones.Add(bone);
                --AppManager.Instance.Player.TotalNumberOfBones;
            } else
        ...
        public void Update()
        {
            ...
            UI.BonesCount = AppManager.Instance.Player.GetTotalNumberOfBones();
