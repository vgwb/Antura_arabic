...
namespace EA4S.Database
{
    ...
    public class LogVocabularyScoreData : IData
    {
        ...
        public LogVocabularyScoreData(string appSession, JourneyPosition journeyPosition, MiniGameCode miniGameCode, VocabularyDataType dataType, string elementId, float score)
        {
