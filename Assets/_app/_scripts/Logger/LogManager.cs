...
namespace EA4S.Core
{
    ...
    public class LogManager
    {
        ...
        protected internal void LogMinigameScore(string playSession, MiniGameCode miniGameCode, int score)
        {
            ...
            EA4S.AppManager.I.Teacher.logAI.LogMiniGameScore(AppSession, EA4S.AppManager.I.NavigationManager.NavData.CurrentPlayer.CurrentJourneyPosition, miniGameCode, score, duration);
        }
        ...
        {
            (EA4S.AppManager.I as EA4S.AppManager).Teacher.logAI.LogPlay(AppSession, (EA4S.AppManager.I as EA4S.AppManager).NavigationManager.NavData.CurrentPlayer.CurrentJourneyPosition, miniGameCode, resultsList);
        }
        ...
        {
            (EA4S.AppManager.I as EA4S.AppManager).Teacher.logAI.LogLearn(AppSession, (EA4S.AppManager.I as EA4S.AppManager).NavigationManager.NavData.CurrentPlayer.CurrentJourneyPosition, miniGameCode, resultsList);
        }
        ...
        public void LogPlaySessionScore(string playSessionId, int score)
        {
            ...
            (EA4S.AppManager.I as EA4S.AppManager).Teacher.logAI.LogPlaySessionScore(AppSession, (EA4S.AppManager.I as EA4S.AppManager).NavigationManager.NavData.CurrentPlayer.CurrentJourneyPosition, score, duration);
        }
        ...
        {
            (EA4S.AppManager.I as EA4S.AppManager).Teacher.logAI.LogLearningBlockScore(learningBlock, score);
        }
        ...
        {
            (EA4S.AppManager.I as EA4S.AppManager).Teacher.logAI.LogInfo(AppSession, infoEvent, parametersString);
        }
        ...
        {
            (EA4S.AppManager.I as EA4S.AppManager).Teacher.logAI.LogMood(AppSession, mood);
        }
