...
namespace EA4S.ReservedArea
{
    ...
    public class ReservedAreaDialog : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            arabicIntroduction += "<b>" + titleLoc.GetLocalizedText(AppManager.Instance.Player.Gender) + "<b/> \n";
            arabicIntroduction += sectionIntroLoc.GetLocalizedText(AppManager.Instance.Player.Gender) + "\n\n";
            ...
            arabicIntroduction += "\n\n" + sectionErrorLoc.GetLocalizedText(AppManager.Instance.Player.Gender); // "\n\n في حال أخطأت، أعد المحاولة باستعمال هذه اللوحة";
        ...
        {
            AppManager.Instance.NavigationManager.GoToReservedArea();
        }
    }
}